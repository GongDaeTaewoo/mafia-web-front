...
function SignupInput({ css }) {
  ...
  const bootstrapPwClass =
    passwordIsValid || password === '' ? '' : 'is-invalid';
  const bootstrapPwConfirmClass =
    passwordsMatch || confirmPassword === '' ? '' : 'is-invalid';
  ...
  return (
    <div css={containerCss}>
      ...
      <div css={partCss}>
        ...
        <input
          className={`form-control ${bootstrapEmailClass} ${emailBgColor}`}
          value={email}
      ...
      {showEmailCodeField && (
        <>
          <div css={partCss}>
            ...
            <input
              className={`form-control ${bootstrapEmailCodeClass} ${emailCodeBgColor}`}
              value={emailCode}
              onChange={handleConfirmEmailCodeChange}
              css={inputCss}
              style={{ borderWidth: '3.5px' }}
              disabled={emailCodeIsDisabled}
            />
          </div>
          {!emailCodeIsValid && (
            <Text
        ...
        <>
          <div css={partCss}>
            ...
            <input
              ...
              onChange={handleConfirmNicknameChange}
              css={inputCss}
              style={{ borderWidth: '3.5px' }}
            />
            <br />
          ...
          <div css={partCss}>
            ...
            <input
              type="password"
              className={`form-control ${bootstrapPwClass}`}
              value={password}
          ...
          <div css={partCss}>
            ...
            <input
              type="password"
              className={`form-control ${bootstrapPwConfirmClass}`}
